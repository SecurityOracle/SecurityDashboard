/**
 * Test file for Job: latest-report
 */

var assert = require ('assert');
var latest_report_SUT = require('../latest-report');

var mockedConfig, mockedDependencies;

describe ('latest-report test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      latest_report_SUT.onRun(config, mockedDependencies, function(err, data){
