/**
 * Test file for Job: vulnerabilities
 */

var assert = require ('assert');
var vulnerabilities_SUT = require('../vulnerabilities');

var mockedConfig, mockedDependencies;

describe ('vulnerabilities test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      vulnerabilities_SUT.onRun(config, mockedDependencies, function(err, data){
